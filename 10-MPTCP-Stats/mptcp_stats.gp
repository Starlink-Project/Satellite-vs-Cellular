reset
set terminal pdfcairo enhanced color font "Helvetica,28" lw 2 size 9.3,4.8
set output 'mptcp_stats.pdf'

set xlabel "Network Provider" offset 0,1.05 font "Helvetica,33"
set ylabel 'Throughput (Mbps)' offset 2.45 font "Helvetica,33"

set xrange [0.6:7.4]
set yrange [0:400]
set xtics offset -0.1,0.4 center
...
set label 1 "Tuned" at screen 0.170,0.865 textcolor rgb "gray30" font "Helvetica,33"
set label 2 "Untuned" at screen 0.770,0.865 textcolor rgb "gray30" font "Helvetica,33"
